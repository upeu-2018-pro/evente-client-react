...
class PersistentDrawer extends React.Component {
  ...
  */
  ...
  lLogin = (event) => {
    this.props.login({
      url: "https://evente-serve.herokuapp.com/o/authorize/",
      client: "rrAcmEKW34DitRKiX4On84LLWNBBkCjEOmpcjmL3",
      redirect: "https://evente-client-react.herokuapp.com", //https://evente-client-react.herokuapp.com http://localhost:3000
      scope: "read",
